...
public class RunMofScript implements ExecutionMessageListener {
	...
	protected void execute(String inputModel) {
		...
		execMgr.setRootDirectory("C:\\Users\\Jokin Garcia\\Dropbox\\workspace_ContinuousEvolution\\ContinuousEvolution_GoogleMaps\\models");
	...
	public void parseAndExecute() {
		...
		String fileURI = curDir + "\\metamodels\\Map.ecore";
	...
	public static void main(String[] args) {
		...
		runM.setEcoreModel(runM.curDir + "\\models\\Map.xmi");
		runM.setTransformation(runM.curDir + "\\transformations\\Map2Web.m2t");

		runM.parseAndExecute();
		System.out.println("Map2Web parseAndExecute end");
	}
